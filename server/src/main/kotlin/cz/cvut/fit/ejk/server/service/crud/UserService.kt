...
class UserService: CrudService<Int, User, CreateUserDto, CreateUserDto, GetUserDto>(), KoinComponent {
    ...
    fun removeFile(id: Int, fileId: Int): GetUserDto? {
        return transaction {
            ...
            transaction {
                UsersFilesMetadata.deleteWhere {
                    (UsersFilesMetadata.userId eq user.id.value) and (UsersFilesMetadata.fileId eq file.id.value)
                }
            }
    ...
    override fun delete(id: Int) {
        transaction {
            ...
            UsersFilesMetadata.deleteWhere { UsersFilesMetadata.userId eq id }
            user.delete()
        }
    }
